...
import { OrganizationImageRepository } from 'adapter/persistence/repository/OrganizationImageRepository';
import { CloudStorageInterfaceToken } from 'di/tokens';
import { CloudStorageInterface } from 'application/shared/port/CloudStorageInterface';

const jpegOptions = { quality: 100, mozjpeg: true };

@Service()
export class UploadOrganizationImageService {
  @Inject(CloudStorageInterfaceToken)
  private storageService: CloudStorageInterface;
